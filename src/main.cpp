...
IRsensor SharpIRPrinter;
SonarSensor SharpSONPrinter;
...
void loop() {
  switch(robot_state)
  {
    ...
    case ROBOT_DRIVING:
      // TODO uncomment this line to check whether the speed controller is operational on your robot
